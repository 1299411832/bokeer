...
- 调整B站视频播放为官方链接格式，调整最新评论悬停时可自动滚动展示，增强侧边工具栏折叠展开交互动画
...
docker buildx build \
  ...
  --target final \
  --build-arg VERSION=v3.5.5 \
  -t noise233/echo-noise:v3.5.5 \
...
docker buildx build \
  ...
  --target final-mcp \
  --build-arg VERSION=v3.5.5 \
  -t noise233/echo-noise:v3.5.5-mcp \
...
docker buildx build \
  ...
  -t noise233/echo-noise:v3.5.5-amd64 \
